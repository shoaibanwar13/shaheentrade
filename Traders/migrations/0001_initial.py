    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Traders.category')),
            ],
        ),
        migrations.CreateModel(
            name='ProductImage',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Traders.product')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('cart', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='Traders.cart')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
        ...
        migrations.AddField(
            model_name='cart',
            name='customer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Traders.customer'),
        ),
        migrations.CreateModel(
            name='Admin',
            fields=[
